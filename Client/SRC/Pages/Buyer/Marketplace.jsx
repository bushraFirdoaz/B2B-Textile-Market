...
function Marketplace() {
  ...
  // Selected product for details popup
  ...
  const formattedSupplierProducts = supplierProducts.map((product) => ({
  ...
  const handleSendInquiry = (e) => {
    ...
    const moq = Number(selectedProduct.moq);
    const stock = Number(selectedProduct.stock || 0);

    // Only validate stock for supplier products
    if (
    ...
    const newInquiry = {
      ...
      // Important for supplier dashboard
      supplierProductId:
        selectedProduct.isSupplierProduct
      ...
      <footer className="marketplace-footer">
        ...
        <div className="footer-content">
          ...
          <div className="footer-brand">
            ...
            <p>
              A B2B textile marketplace connecting buyers
              with trusted fabric suppliers.
            </p>
